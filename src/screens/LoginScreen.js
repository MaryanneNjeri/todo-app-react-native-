            ...
            <Container>
                ...
                <Content>
                    ...
                    <View style={styles.buttonContainer}>
                       <Button iconLeft style={{backgroundColor:'#0033cc'}}><Icon name="facebook" type="FontAwesome" style={{color:'white'}}/><Text style={{color:'white',fontWeight:'200',fontSize: 13}}>Login with facebook</Text></Button>
                        <Text>{" "}</Text>
                        <Button iconLeft danger><Icon name="googleplus" type="AntDesign" style={{color:'white'}}/><Text style={{color:'white',fontWeight:'200',fontSize:13}}>Login with google</Text></Button>
                    </View>
                </Content>
            </Container>
        )
